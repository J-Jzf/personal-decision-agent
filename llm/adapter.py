...
class ModelAdapter:
    ...
    async def react_or_fallback(self, *, task: TaskSpec, request: DecisionRequest,
        ...
        try:
            ...
            react_request = request.model_dump(mode="json")
            react_request.pop("candidates", None)
            return await self._structured_with_repair(
                ...
                "必须阅读 execution_context.react_context。它只包含用户问题、当前 target、当前 target completion_criteria、"
